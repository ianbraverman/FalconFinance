    ...
    return (
        <>
            <p> 
                ...
                <p>Create Your Account: Begin by signing up for a new account. Your information is secure with us, and we value your privacy.</p>
                <p>Log In: Once your account is set up, log in to access your personalized dashboard.</p>
                <h1>How It Works: </h1>
                <p>Fill Out Your Financial Profile: </p>
                <p>After logging in, you'll be directed to a comprehensive survey. Here, you'll enter important details about your finances:</p>
                ...
                <li>Income: Provide details about your earnings from various sources.</li>
                ...
                <h1>Join Us Today!</h1>
                <p>Ready to transform your financial future? Sign up now and take the first step towards achieving your financial goals.</p>
                <p>Thank you for choosing Financial Budgeting Website. We're here to make your financial dreams a reality!</p>
